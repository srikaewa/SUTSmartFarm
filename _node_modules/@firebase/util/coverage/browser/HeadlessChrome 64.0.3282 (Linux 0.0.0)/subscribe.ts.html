...
<span class="cstat-no" title="statement not covered" >      throw new Error('Missing Observer.');</span>
    }
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.observerCount === 0 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >this.onNoObservers !== undefined)</span> {
