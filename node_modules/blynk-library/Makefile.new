...
all: dist/blynk.min.js dist/blynk-library-js.ipk dist/blynk-espruino.min.js
...
dist/blynk.js: dist
	browserify . --standalone Blynk -o $@

dist/blynk.min.js: dist dist/blynk.js
	uglifyjs -o $@ dist/blynk-browser.js

dist/blynk-espruino.min.js: dist
	uglifyjs -o $@ blynk.js
